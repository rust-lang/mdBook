...
fn unclosed_html_tags() {
 ...
 INFO Book building has started
 INFO Running the html backend
 WARN unclosed HTML tag `<i>` (opened at line 1) found in `chapter_1.md` at end of document (line 1)
 WARN unclosed HTML tag `<span>` (opened at line 1) found in `chapter_1.md` at end of document (line 1)
 WARN unclosed HTML tag `<div>` (opened at line 1) found in `chapter_1.md` at end of document (line 1)
 INFO HTML book written to `[ROOT]/book`
...
fn unclosed_html_tags_line_numbers() {
 ...
 INFO Book building has started
 INFO Running the html backend
 WARN unclosed HTML tag `<span>` (opened at line 3) found in `chapter_1.md` at end of document (line 5)
 WARN unclosed HTML tag `<div>` (opened at line 3) found in `chapter_1.md` at end of document (line 5)
 INFO HTML book written to `[ROOT]/book`
...
fn heading_with_unbalanced_html() {
 ...
 INFO Book building has started
 INFO Running the html backend
 WARN unclosed HTML tag `<t>` (opened at line 1) found in `chapter_1.md` while exiting Heading(H3) at line 1
