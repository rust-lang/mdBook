...
fn readme_to_index() {
    ...
    test.check_main_file(
        "book/index.html",
        str![[r##"<h1 id="intro"><a class="header" href="#intro"></a>Intro</h1>"##]],
    )
    .check_main_file(
        "book/first/index.html",
        str![[r##"<h1 id="first"><a class="header" href="#first"></a>First</h1>"##]],
    )
    .check_main_file(
        "book/second/index.html",
        str![[r##"<h1 id="second"><a class="header" href="#second"></a>Second</h1>"##]],
    )
    .check_toc_js(str![[r#"
<ol class="chapter">
