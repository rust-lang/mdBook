...
fn check_correct_relative_links_in_print_page() {
    ...
    assert_contains_strings(
        ...
        &[
            ...
            r##"<sup class="footnote-reference" id="first-markdown-fr-1-1"><a href="#first-markdown-footnote-1">1</a></sup>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-1-2"><a href="#first-markdown-footnote-1">1</a></sup>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-word-1"><a href="#first-markdown-footnote-word">2</a></sup>.</p>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-word-2"><a href="#first-markdown-footnote-word">2</a></sup>.</p>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-para-1"><a href="#first-markdown-footnote-para">3</a></sup></p>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-multiple-1"><a href="#first-markdown-footnote-multiple">4</a></sup></p>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-&quot;wacky&quot;-1"><a href="#first-markdown-footnote-&quot;wacky&quot;">5</a></sup></p>"##,
            r##"<sup class="footnote-reference" id="first-markdown-fr-define-before-use-1"><a href="#first-markdown-footnote-define-before-use">6</a></sup></p>"##,
            r##"<a href="#first-markdown-fr-1-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-1-2">↩2</a>"##,
            r##"<a href="#first-markdown-fr-word-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-word-2">↩2</a>"##,
            r##"<a href="#first-markdown-fr-para-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-multiple-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-&quot;wacky&quot;-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-define-before-use-1">↩</a>"##,
            r##"<a href="#first-markdown-fr-multiple-1">↩</a>"##,
        ],
    );
}
