...
async fn serve(
    ...
    let app = axum::Router::new()
        // This upgrades to a websocket, and then waits for any filesystem change notifications,
        // and relays them over the websocket:
        .route(&format!("/{LIVE_RELOAD_ENDPOINT}"), get(reload_ws_handler))
...
async fn reload_ws_handler(
    ws: WebSocketUpgrade,
    State(reload_tx): State<broadcast::Sender<Message>>,
) -> impl IntoResponse {
