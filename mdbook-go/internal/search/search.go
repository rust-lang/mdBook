// Package search is a Go port of the elasticlunr index builder that mdBook
// uses, producing JSON output byte-identical to elasticlunr-rs v3.1.0.
//
// It implements the English-language Porter stemmer pipeline (trimmer,
// stopWordFilter, stemmer) and the inverted-index trie used by
// elasticlunr.js's on-disk search index format.
package search
