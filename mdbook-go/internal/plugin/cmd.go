...
func (c *CmdPreprocessor) Run(ctx *PreprocessorContext, b *book.Book) (*book.Book, error) {
...
// complete.
func (c *CmdRenderer) Render(ctx *RenderContext) error {
