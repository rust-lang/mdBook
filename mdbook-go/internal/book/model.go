// Package book defines the in-memory book model used across the driver and
// renderers. The shape mirrors crates/mdbook-core/src/book.rs so that JSON
// serialisation stays compatible with the existing preprocessor and renderer
// protocol.
package book
