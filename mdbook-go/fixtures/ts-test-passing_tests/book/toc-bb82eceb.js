...
class MDBookSidebarScrollbox extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = '<ol class="chapter"><li class="chapter-item expanded "><span class="chapter-link-wrapper"><a href="intro.html">Intro</a></span><ol class="section"><li class="chapter-item expanded "><span class="chapter-link-wrapper"><a href="passing1.html"><strong aria-hidden="true">1.</strong> Passing 1</a></span></li><li class="chapter-item expanded "><span class="chapter-link-wrapper"><a href="passing2.html"><strong aria-hidden="true">2.</strong> Passing 2</a></span></li></ol></li></ol>';
